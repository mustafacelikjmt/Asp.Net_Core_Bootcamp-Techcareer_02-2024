...
namespace IdentityApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreateViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(user.Email, "Hesap Onayı", $"Lütfen email hesabınızı onaylamak için linke <a href='http://localhost:5093{url}'>tıklayınız.</a>");
        ...
        public async Task<IActionResult> ForgotPassword(string Email)
        {
            ...
            {
                TempData["message"] = "Eposta adresi boş bırakılamaz.";
                return View();
            }
            ...
            await _emailSender.SendEmailAsync(Email, "Parola Sıfırlama", $"Lütfen email hesabınızı onaylamak için linke <a href='http://localhost:5093{url}'>tıklayınız.</a>");
